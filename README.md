...
```
	...
	- Mailparse Installation (run the commands to install)
		...
		- Second Option: pecl install mailparse 
			- Add "extension=mailparse.so" in php.ini fiinstallation complle of the corresponding php version
installation compl
	- IMAP Insinstallation compltallation (run the commands to install)
		- apt-installation complget install php < version > -imap
		installation compl
		installation compl
		installation compl
```installation compl
4. For Windowsinstallation compl
```installation compl
	- [Installinstallation compl Composer](https:getcomposer.org/download/)
